...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('static/unify/plugins/bootstrap/css/bootstrap.min.css') }}">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="page_home8.html">Option 9: Home Discover</a></li>
                                    <li><a href="page_jobs.html">Option 10: Home Jobs</a></li>
                                    <li><a href="page_home9.html">Option 11: Home Boxed</a></li>
                                    <li><a href="page_home11.html">Option 12: Home Boxed Image</a></li>
                                    <li><a href="page_home10.html">Option 13: Home Fixed Menu</a></li>
                                </ul>
                            </li>
                            <!-- End Home -->
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="feature_typo_dividers.html"><i class="fa fa-ellipsis-h"></i> Deviders</a></li>
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="feature_icon_line.html"><i class="fa fa-chevron-circle-right"></i>  Icons</a></li>
                                            <li><a href="feature_icon_glyph.html"><i class="fa fa-chevron-circle-right"></i> Glyphicons Icons</a></li>
                                        </ul>
                                    </li>
                                    <!-- End Icons -->
                                    ...
                                    <!-- Thumbnails -->
                                    <li><a href="feature_thumbails.html">Thumbnails</a></li>
                                    <!-- End Thumbnails -->
                                    ...
                                    <!-- Accordion and Tabs -->
                                    <li><a href="feature_accordion_and_tabs.html">Accordion &amp; Tabs</a></li>
                                    ...
                                    <!-- Carousel -->
                                    <li><a href="feature_carousels.html">Carousel Examples</a></li>
                                    <!-- End Carousel -->
                                    ...
                                    <!-- Tables -->
                                    <li><a href="feature_table_general.html">Tables</a></li>
                                    <!-- End Tables -->
                                    ...
                                    <li><a href="feature_compo_charts.html">Charts &amp; Countdowns</a></li>
