...
<div id="content">
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blueDark"><i class="fa fa-table fa-fw "></i> 我的讨论区 <span>&gt; 我的话题 </span></h1>
        </div>
    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('user.discuss.topic.edit', $discuss->id) }}" class="btn btn-success btn-xs">编辑</a>
        ...
        $.SmartMessageBox({
            ...
            buttons : '[取消][确认]'
                ...
                if (ButtonPressed === "确认") {
                    $.ajax({
                        type: "GET",
                        url: "{{ route('user.discuss.topic.ajax.delete') }}/" + id,
                        dataType: "json",
                        async: "true",
