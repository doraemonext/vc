...
<div id="content">
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blueDark"><i class="fa fa-table fa-fw "></i> 讨论区管理 <span>&gt; 编辑话题 </span></h1>
        </div>
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            <a data-toggle="modal" href="{{ route('admin.discuss.topic') }}" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-circle-arrow-up fa-lg"></i> 返回话题管理列表</a>
        </div>
    </div>
                ...
                <div class="jarviswidget jarviswidget-color-darken jarviswidget-sortable" id="wid-id-1" data-widget-editbutton="false" role="widget" style="">
                    ...
                    <div role="content">
                        ...
                        <div class="widget-body">
                            {{ Form::open(array('action' => array('AdminDiscussController@submitTopicEdit', $discuss->id), 'class' => 'form-horizontal')) }}
                                <fieldset>
