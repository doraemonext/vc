...
<div id="content">
    <div class="row">
        <div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
            <h1 class="page-title txt-color-blueDark"><i class="fa fa-table fa-fw "></i> 讨论区管理 <span>&gt; 话题管理 </span></h1>
        </div>
    </div>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('discuss.item', $discuss->id) }}" class="btn btn-info btn-xs">查看</a>
                                            <a href="{{ route('admin.discuss.topic.edit', $discuss->id) }}" class="btn btn-success btn-xs">编辑</a>
                                            <a class="btn btn-danger btn-xs ajax-delete" data-id="{{ $discuss->id }}">删除</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
        ...
        $.SmartMessageBox({
            ...
            buttons : '[取消][确认]'
                ...
                if (ButtonPressed === "确认") {
                    $.ajax({
                        type: "GET",
                        url: "{{ route('admin.discuss.topic.ajax.delete') }}/" + id,
                        dataType: "json",
                        async: "true",
