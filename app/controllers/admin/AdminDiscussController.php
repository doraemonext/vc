...
class AdminDiscussController extends BaseController {
    ...
    public function __construct() {
        View::composer(array(
            'admin.discuss_topic',
            'admin.discuss_topic_edit',
            'admin.discuss_comment',
            'admin.discuss_comment_edit',
        ), function($view)
        {
    ...
    public function showTopic()
    {
        ...
        // 在数据库中进行查询
        $discusses = Discuss::orderBy('datetime', 'DESC')->paginate($paginateNumber);

        return View::make('admin.discuss_topic')->with('discusses', $discusses);
    }
    ...
    public function showTopicEdit($id)
    {
        ...
        try {
            ...
            return Redirect::route('admin.discuss.topic');
        }
        ...
        return View::make('admin.discuss_topic_edit', $data);
    }
    ...
    public function showComment()
    {
        ...
        // 在数据库中进行查询
        $comments = DiscussComment::orderBy('datetime', 'DESC')->paginate($paginateNumber);

        return View::make('admin.discuss_comment')->with('comments', $comments);
    }
    ...
    public function showCommentEdit($id)
    {
        ...
        try {
            ...
            return Redirect::route('admin.discuss.comment');
        }
        ...
        return View::make('admin.discuss_comment_edit', $data);
    }
    ...
    public function submitTopicEdit($id)
    {
        ...
        if ($validator->fails()) {
            return Redirect::route('admin.discuss.topic.edit', $discuss->id)->withErrors($validator)->withInput($input);
        }
    ...
    public function submitCommentEdit($id)
    {
        ...
        $validator = Validator::make($input, $rules, Config::get('validation'));
        if ($validator->fails()) {
            return Redirect::route('admin.discuss.comment.edit', $comment->id)->withErrors($validator)->withInput($input);
        }
        ...
        Session::flash('status', 'success');
        Session::flash('message', '您已成功编辑该评论');
        return Redirect::route('admin.discuss.comment');
    }
