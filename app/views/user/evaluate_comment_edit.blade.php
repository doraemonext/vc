...
<div id="content">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-5 col-lg-8">
            ...
            <a data-toggle="modal" href="{{ route('user.evaluate.comment.showcase') }}" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-circle-arrow-up fa-lg"></i> 返回我的评论列表</a>
            @elseif ($type == 'news')
            <a data-toggle="modal" href="{{ route('user.evaluate.comment.news') }}" class="btn btn-success btn-lg pull-right header-btn hidden-mobile"><i class="fa fa-circle-arrow-up fa-lg"></i> 返回我的评论列表</a>
            @endif
        </div>
    </div>
